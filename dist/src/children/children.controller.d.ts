...
export declare class ChildrenController {
    ...
    create(createChildDto: CreateChildDto, user: CurrentUserData): Promise<{
        parent: {
            id: number;
            email: string;
            fullName: string;
    ...
    findAll(user: CurrentUserData, parentId?: number): Promise<({
        devices: {
            status: import("@prisma/client").$Enums.Status;
            id: number;
    ...
    findMyChildren(user: CurrentUserData): Promise<({
        devices: {
            status: import("@prisma/client").$Enums.Status;
            id: number;
            deviceName: string | null;
    ...
    update(id: number, updateChildDto: UpdateChildDto, user: CurrentUserData): Promise<{
        parent: {
            id: number;
            email: string;
            fullName: string;
