...
let DevicesController = class DevicesController {
    ...
    update(id, updateDeviceDto, user) {
        return this.devicesService.update(id, updateDeviceDto, user.schoolId);
    }
    remove(id, user) {
        return this.devicesService.remove(id, user.schoolId);
    }
    linkToChild(body, user) {
        return this.devicesService.linkToChild(body.deviceId, body.childId, user.schoolId);
    }
};
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], DevicesController.prototype, "linkToChild", null);
